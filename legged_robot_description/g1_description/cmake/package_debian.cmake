...
set(CPACK_PACKAGE_CONTACT ${maintainer_name} ${maintainer_email})
set(CPACK_PACKAGE_VENDOR "VinMotion, Hanoi, Vietnam")
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "VinMotion ${PROJECT_NAME} package")

# # add date stamp to PROJECT_VERSION
# string(TIMESTAMP STAMP "%Y%m%d+%H%M%S")
# set(PROJECT_VERSION "${PROJECT_VERSION}-0+${STAMP}")
...
# CPACK_PACKAGE_VERSION with devel
...
# set CPACK_SET_DESTDIR to install to CMAKE_INSTALL_PREFIX
...
message(STATUS "Package will be installed to CMAKE_INSTALL_PREFIX=${CMAKE_INSTALL_PREFIX}")
