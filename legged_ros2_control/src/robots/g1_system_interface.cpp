...
CallbackReturn
G1SystemInterface::on_init(const hardware_interface::HardwareInfo &info) {
...
return_type G1SystemInterface::read(const rclcpp::Time & /*time*/,
...
return_type G1SystemInterface::write(const rclcpp::Time & /*time*/,
                                     const rclcpp::Duration & /*period*/) {
  ...
  //   RCLCPP_INFO(*logger_, "Average write period over 100 calls: %.6f s, Max
  //   period: %.6f s", avg_period, max_period); call_count = 0; period_sum =
  //   0.0; max_period = 0.0;
  // }
...
PLUGINLIB_EXPORT_CLASS(legged::G1SystemInterface, legged::LeggedSystemInterface)
